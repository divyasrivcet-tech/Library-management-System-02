...
<meta name="verify-admitad" content="fb09364f2b" />
    ...
    <script type="text/javascript" src="/public/js/main.js?v=127" defer></script>
    ...
    <div class="split-pane-component " id="left-component" style="background-color: #125792;">
        <div style="background-color: #125792; padding:10px 0px 0px 0px">
          ...
          <div style="text-align: center;    color: #ccd7dd;    padding: 10px 0px;    font-style: italic;    border-top: 1px solid #658a9e;    border-bottom: 1px solid #658a9e;">
              ...
              Welcome, <a href="/profile/" style="color:white; font-size:inherit"><b>DIVYASRI</b></a>
              <a href="/notifications" id="notification_bell">
...
<!--                    <li ><a href="/career">Jobs <span class="label label-danger">new</span></a></li>-->
                ...
                <li ><a href="/upgrade-premium">Upgrade</a></li>
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="/logout?from=all" >Logout from all devices</a></li>
                      </ul>
                    </div>
                </li>
...
<span style="float:none;clear:both">&copy; 2016 - 2025 GDB Online</span>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.loadtemplate/1.5.10/jquery.loadTemplate.js"></script>
...
<script>
  ...
  gtag('config', 'G-6LBEGBJ3W0', {'user_id': '17661793'});
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9b37b5d31cee9fec',t:'MTc2NjY1OTEyMQ=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
